<template>
  ...
  <div class="card" style="width: 70%;padding:40px 20px">
    ...
    <div style="width: 100%;display: flex;justify-content: center;margin-bottom: 20px">
      ...
      >
        <img v-if="data.form.avatar" :src="data.form.avatar"  class="avatar" style="width: 120px; height: 120px"  />
      ...
      <el-form-item  label="工号" prop="no" >
        <el-input disabled v-model="data.form.no" autocomplete="off" placeholder="请输入年龄" />
      </el-form-item>
